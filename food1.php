...
<html lang="en">
  ...
  <body>
    ...
    <!-- header -->
    <div id="head-container" style="background-image:url(images/kaiseki_4.jpg);">
      <div class="head-title">Kaiseki Ryori</div>
    </div>
    ...
    <div id="content">
      <table id="content-table">
        <tr class="verticalTop">
          <td width="30%">
            <div class="spaceTop">
              <img src="images/kaiseki_3.jpg" alt="kaiseki1" class="content-image">
            </div>
          </td>
          <td width="70%">
            <div class="spaceTop">
              <span class="titleLeft">Description</span>
              <p class="textLeft">Kaiseki Ryori can be regarded as an art form that balances taste, texture, and appearance. The ingredients used in Kaiseki Ryori are seasonal and represent the area that it was made in. Each individual course is created to enhance the food’s flavor and each dish is also beautifully garnished. A typical Kaiseki Ryori set contains an appetizer, sashimi, simmered fish, a grilled dish and a steamed dish. There are many variations to Kaiseki Ryori and each restaurant may serve something different depending on the chef.</p>
            </div>
          </td>
        </tr>
        <tr class="verticalTop">
          <td>
            <div>
              <img src="images/kaiseki_2.jpg" alt="kaiseki2" class="content-image">
            </div>
          </td>
          <td>
            <div>
              <span class="titleLeft">Recommendation</span>
              <p class="textLeft">For Kaiseki Ryori We recommend Ganko Takasegawa Nijoen(がんこ高瀬川二条苑). Ganko Takasegawa has been serving traditional Kyoto Kaiseki for over 400 years and provides maiko(apprentice geisha) performances.</p>
              <span class="textLeft">Address:Japan, 〒604-0922 Kyoto Prefecture, Kyoto, 中京区木屋町通二条下ル東生洲町484-6</span><br>
              <span class="textLeft">Hours of Operation: 11:00am to 9:30pm</span><br>
              <span class="textLeft">Price: 3000 - 4000 yen for lunch, 5000 - 6000 yen for dinner</span><br>
            </div>
          </td>
        </tr>
      </table>
    ...
    <?php $result->close(); ?>
    <?php if ($loginflag) { ?>
      <form name="comment" method="post" action="food1.php">
        <table id="comment-table">
          <tr>
            <td>
